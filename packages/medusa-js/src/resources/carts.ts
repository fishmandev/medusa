...
class CartsResource extends BaseResource {
   ...
   * @return {Response<StoreCartsRes>}
   */
  complete(cart_id: string): Response<StoreCartsRes> {
   ...
   * @return {Response<StoreCartsRes>}
   */
  create(payload?: StorePostCartReq): Response<StoreCartsRes> {
   ...
   * @return {Response<StoreCartsRes>}
   */
  createPaymentSessions(cart_id: string): Response<StoreCartsRes> {
   ...
   * @return {Response<StoreCartsRes>}
   */
  deleteDiscount(cart_id: string, code: string): Response<StoreCartsRes> {
   ...
   * @return {Response<StoreCartsRes>}
   */
  retrieve(cart_id: string): Response<StoreCartsRes> {
