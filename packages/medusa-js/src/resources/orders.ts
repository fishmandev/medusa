...
class OrdersResource extends BaseResource {
   ...
   * @return {Response<StoreOrdersRes>}
   */
  retrieve(id: string): Response<StoreOrdersRes> {
   ...
   * @return {Response<StoreOrdersRes>}
   */
  retrieveByCartId(cart_id: string): Response<StoreOrdersRes> {
   ...
   * @return {Response<StoreOrdersRes>}
   */
  lookupOrder(payload: StoreGetOrdersParams): Response<StoreOrdersRes> {
